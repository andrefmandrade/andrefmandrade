[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=60B5F7&center=true&vCenter=true&width=435&lines=Hello+there+...+General+Kenobi.)](https://git.io/typing-svg)
```JavaScript
const aboutMe = {
  name: 'André Andrade',
